...
;(function($) {
    $.fn.formset = function(opts)
    {
        ...
        if ($$.length) {
            ...
            //var addButtonHTML = '<input type="button" value="' + options.addText + '" class="btn btn-default mr-2 ' + options.addCssClass + '" id="qfilter-wizard-multi-form-add-more"></input>';
            ...
            addButton.click(function() {
                ...
                var formCount = parseInt(totalForms.val()),
                    ...
                    buttonRow = $($(this).parents('tr.' + options.formCssClass + '-add').get(0) || $(this).parents().find('.' + options.addFormContainerClass).get(0)  || this),
